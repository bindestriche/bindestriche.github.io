...
/** @type {string} */
const CACHE_VERSION = '1752265382|1729609882';
/** @type {string} */
const CACHE_PREFIX = 'cool again1-sw-cache-';
...
/** @type {string[]} */
const CACHED_FILES = ["test1.html","test1.js","test1.offline.html","test1.icon.png","test1.apple-touch-icon.png","test1.audio.worklet.js","test1.audio.position.worklet.js"];
